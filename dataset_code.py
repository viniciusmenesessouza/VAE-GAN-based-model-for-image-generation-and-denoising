...
def get_dataset_loaders(path, batch_size=64, train_p=0.9, dataset_size=None, dataset_type='HQ', image_size=(64, 64), num_workers=0):
    if dataset_type == 'HQ':
        dataset = CelebAHQDataset(path, dataset_size)
    elif dataset_type == 'LQ':
        dataset = CelebADatasetV0(path, image_size=image_size ,dataset_size=dataset_size)
